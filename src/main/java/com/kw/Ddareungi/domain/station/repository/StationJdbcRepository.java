...
public class StationJdbcRepository implements StationRepository {
    ...
    @Override
    public int updateStationSelectively(Long stationId, String stationName, String address, Double latitude, Double longitude, Integer capacity, Integer availableBikes, LocalDate installationDate, LocalTime closedDate, Long modifiedById) {
